...
const MyBookings = () => {
  ...
  return (
    <>
      <Helmet><title>My Bookings | InstaNest</title></Helmet>
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="overflow-x-auto">
          <table className="table w-full">
            <thead>
              <tr>
                <th>Room</th><th>Check‑In</th><th>Guests</th><th>Total</th><th>Actions</th>
              </tr>
            </thead>
            <tbody>
              {bookings.map(b => (
                <tr key={b._id}>
                  ...
                  <td>${b.totalPrice}</td>
                  <td>
                    <button onClick={() => cancelBooking(b._id, b.checkIn)} className="btn btn-sm btn-error mr-2">Cancel</button>
                  </td>
                </tr>
              ))}
            </tbody>
