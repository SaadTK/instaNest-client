...
//   return (
//     <>
//       <Helmet><title>{room.name} | InstaNest</title></Helmet>
//       <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
//         <img src={room.image} alt={room.name} className="w-full h-80 rounded-lg object-cover" />
...
//         <button className="btn btn-primary" onClick={() => setBookingMode(true)}>Book Now</button>
//         <section className="mt-10">
//           <h3 className="text-2xl font-semibold mb-4">Reviews</h3>
//           <ReviewList reviews={reviews} />
//         </section>
//         {bookingMode && <BookNowModal room={room} onConfirm={handleBook} onClose={() => setBookingMode(false)} />}
//       </div>
//     </>
//   );
// };
